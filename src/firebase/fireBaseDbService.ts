import {collection, doc, getDoc, deleteDoc, getCountFromServer, setDoc, updateDoc} from "firebase/firestore"
...
export const updateProduct = async (id: string, updatedData: Partial<ProductType>): Promise<void> => {
    const ref = doc(productCollection, id);
